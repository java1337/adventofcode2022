...
class Day20221201(private val input: List<String>): DailyChallenge {

    companion object {
        fun create(): Day20221201 {
            val input = Utils.readFileAsListOfString("Day20221201.txt")
            return Day20221201(input)
        }
    }
    ...
    override fun second() = parseElvesLoads().sorted().reversed().take(3).sum().toString()
    override fun getLabel() = "2022/12/01 - Calorie Counting"
}